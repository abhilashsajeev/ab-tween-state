...
[Live demo](https://rawgit.com/abhilashsajeev/ab-tween-state/master/examples/index.html) and [source](https://github.com/abhilashsajeev/ab-tween-state/tree/master/examples).

Npm:
```sh
npm install ab-tween-state
```

Bower:
```sh
bower install ab-tween-state
```
...
```js
var tweenState = require('ab-tween-state');
